...
Write-Host "🔍 Verificando build de produção do App Cliente Modelo 2..." -ForegroundColor Cyan
Write-Host ""
...
if ($LASTEXITCODE -ne 0) {
    Write-Host "❌ Erros de lint encontrados. Corrija antes de fazer deploy." -ForegroundColor Red
    exit 1
}
